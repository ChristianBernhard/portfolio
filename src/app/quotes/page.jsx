...
function Quote({author, children}) {
    return (
        <li className="bg-white shadow-lg rounded-lg overflow-hidden">
            <blockquote className="p-8 italic text-lg leading-relaxed text-gray-600 border-l-4 border-blue-500">
                <p>“{children}”</p>
                <footer className="mt-4 text-gray-500 text-right">{author}</footer>
            </blockquote>
        </li>
    );
}
