...
export const skills = [
  {
    category: 'Build & ship AI applications',
    items: [
      tech('Voice AI agents'),
      tech('RAG & knowledge systems'),
      tech('Multimodal / VLM'),
      tech('Multi-agent workflows'),
      tech('Realtime voice (LiveKit · Realtime & STT/LLM/TTS pipeline)'),
      tech('Demos, PoCs & product delivery'),
      tech('Next.js · React · FastAPI'),
    ],
  },
  {
    category: 'Models, agents & quality',
    items: [
      tech('Open & closed LLMs (GPT, LLaMA, Qwen, Nemotron, …)', logoMeta),
      tech('Fine-tuning (LoRA / QLoRA)'),
      tech('Embedding models'),
      tech('LangGraph · LangChain'),
      tech('Context engineering'),
      tech('Eval & observability (RAGAS, Langfuse)'),
      tech('MCP / tool use'),
    ],
  },
  {
    category: 'NVIDIA & production inference',
    items: [
      tech('NVIDIA AI Enterprise', logoNvidia),
      tech('NIMs', logoNvidia),
      tech('TensorRT-LLM', logoNvidia),
      ...
      tech('DGX Spark · H100 · H200 · DGX B300', logoNvidia),
      tech('GPU sizing & TCO'),
      tech('PyTorch · HuggingFace'),
    ],
  },
  {
    category: 'Cloud, platform & delivery',
    items: [
      tech('Azure AI (Foundry · OpenAI · Search)'),
      tech('Sovereign & on-prem AI'),
      tech('Docker · Kubernetes'),
      tech('Python · TypeScript'),
      tech('Enterprise & regulated deployments'),
    ],
  },
  {
    category: 'Lead & enable',
    fullWidth: true,
    items: [
      tech('Technical workshops & keynotes'),
      tech('C-level & executive advisory'),
      tech('Team leadership (FDE teams)'),
      tech('Pre-sales → production delivery'),
    ],
  },
]
